...
export default function PageHero({ eyebrow, title, intro, breadcrumbs }: Props) {
  return (
    <section
      ...
      className="bg-gradient-to-br from-navy-900 via-navy-800 to-navy-700 pb-16 pt-36 text-white md:pb-24 md:pt-44"
    >
      <div className="container-narrow">
        ...
        <h1 id="page-hero-heading" className="mt-4 font-display text-4xl text-white sm:text-5xl md:text-6xl">
          {title}
        </h1>
